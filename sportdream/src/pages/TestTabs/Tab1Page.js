...
class Main extends Component{
    ...
    gotoSmartBasketballStand = ()=>{
        this.props.dispatch(NavigationActions.navigate({routeName:'SmartBasketballStand'}))
    }
    ...
    gotoQiniuLive = async()=>{
        if(Platform.OS == 'ios'){
            ...
            var result = "rtmp://pili-publish.2310live.com/grasslive/test2" //await post("/getPublishURL",{streamname:"singlematch_roomid"})
            QiniuModule.Zhibo(result);
        }else{
                    ...
                    <View style={{flex:1}}>
                        <ScrollView style={{flex:1}}>
                                ...
                                <WingBlank>
                                    <View>
                                        <WhiteSpace/>
                                        <Button onClick={this.gotoSmartBasketballStand}>智能篮球架</Button>
                                        <WhiteSpace/>
