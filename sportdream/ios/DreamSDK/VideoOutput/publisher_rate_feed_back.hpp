...
#ifndef publisher_rate_feed_back_hpp
#define publisher_rate_feed_back_hpp

#include <stdio.h>
#include "platform_4_live_common.h"
#include "live_video_quality_agent.hpp"
#include <vector>
#include <string>
#include <sstream>
#include <map>
...
private:
  ...
  std::map<std::string, WriteTimeInfo*> writeTimeMapping;
...
public:
  ...
  void publishPktSuccess(int pktSize,int writeTimeInterval);
  ...
  virtual void registerStatisticsBitrateCallback(
                                                 int (*statistics_bitrate_callback)(int sendBitrate, int compressedBitrate,
                                                                                    void *context),
                                                 void *context);
  VideoQualityAgent* getQualityAgent();
};

#endif /* publisher_rate_feed_back_hpp */
