...
-(void)layoutSessions:(NSArray<VideoChatSession *> *)sessions inContainer:(UIView *)container
{
  ...
  for(VideoChatSession* session in sessions)
  {
    [session.hostingView removeFromSuperview];
  }
  
  NSArray* allViews = [self viewListFromSessions:sessions];
...
-(NSArray<UIView*>*)viewListFromSessions:(NSArray<VideoChatSession *> *)sessions
{
