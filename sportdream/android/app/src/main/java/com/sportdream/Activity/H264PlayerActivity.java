 ...
 *
 */
public class H264PlayerActivity extends Activity implements SurfaceHolder.Callback {
    private VideoDecoderThread mVideoDecoder;

    private static final String FILE_PATH = Environment.getExternalStorageDirectory() + "/cloudy_night.mp4";
